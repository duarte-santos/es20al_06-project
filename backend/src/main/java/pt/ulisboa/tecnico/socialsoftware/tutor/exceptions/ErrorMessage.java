...
public enum ErrorMessage {
    ...
    NOT_ENOUGH_QUIZZES("The student has less than two quizes"),
    ...
    CANNOT_EDIT_SQ_REJECTED("Student's question can only be edited if rejected"),
    CANNOT_EDIT_SQ_APPROVED("Student's question can only be edited if approved"),
